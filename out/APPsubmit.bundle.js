...
/***/ function(module, exports, __webpack_require__) {
	...
	var APPagreement = __webpack_require__(184);
	var APPform = __webpack_require__(185);
	    ...
	    React.createElement(
	        ...
	        React.createElement(
	            ...
	            React.createElement(
	                'div',
	                { className: 'app_wrap' },
	                React.createElement(APPagreement, null),
	            ...
	            return React.createElement(
	                ...
	                React.createElement(
	                    ...
	                    React.createElement(
	                        ...
	                        React.createElement(
	                            'a',
	                            { className: 'nav_item on', href: '#' },
	                            '首页'
	                        ),
	                        React.createElement(
	                            'a',
	                            { className: 'nav_item', href: '#' },
	                            '资源目录'
	                        ),
	                        React.createElement(
	                            'a',
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "/* header */\r\n#header{ padding:19px 0; position:fixed; width:100%; left:0; top:0; z-index:3; background: #373e72;}\r\n.logo{ font-size:0;}\r\n.logo a{ display:block;}\r\n.nav_item{ display:inline-block; height:38px; line-height:38px; margin:0 20px; font-size:16px; color:#bbc0ff; position:relative;transition:0.3s}\r\n.nav_item:before{ content: ''; position:absolute; top:0; left:-19px; width:100%; height:100%; padding:0 19px; border-radius:19px; background:#bbc0ff;z-index:-1; visibility: hidden; opacity:0; transition:0.3s;transform:scale(0);}\r\n.nav_item:hover{ color:#212342;}\r\n.nav_item.on{ color:#fff;}\r\n.nav_item:hover:before{ opacity:1; transform:scale(1); visibility: visible;}\r\n.nav_item.on:hover:before{ opacity:0; transform:scale(0);visibility: hidden;}\r\n.login,.regesiter{ display:inline-block; box-sizing:border-box; width:86px; height:38px; border-radius:3px; line-height:38px; text-align:center; margin-left:10px; font-size:16px;}\r\n.login{ color:#fff; background:#3085d5;}\r\n.login:hover{ background:#3696f0; transition:0.3s;}\r\n.regesiter{ border:1px solid #d3d6ff; color:#d3d6ff;}\r\n.regesiter:hover{ color:#fff; border-color:#fff; transition:0.3s;}", ""]);
	                ...
	                React.createElement(
	                    ...
	                    React.createElement(
	                        ...
	                        React.createElement(
	                            'div',
	                            { className: 'about' },
	                            React.createElement('img', { src: '../img/logo_footer.png' }),
	                            React.createElement(
	                                'p',
	                                null,
	                                React.createElement(
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "/* footer */\r\n#footer{ background:#212342; padding:30px 0; position:relative; z-index:1;}\r\n.copy_right{ padding:0 50px;}\r\n.footer_list{ float:left; width:235px;}\r\n.footer_list dt{ font-size:14px; padding-bottom:22px; color:#bbc0ff}\r\n.footer_list dd{ line-height:28px; font-size:12px;}\r\n.footer_list dd a{ color:#505aa6}\r\n.about{ float:right;}\r\n.about img{ display:block; padding:10px 0 20px 0;}\r\n.about p{ line-height:28px; color:#505aa6; font-size:12px;}\r\n.about p a{ color:#505aa6; margin:0 7px;}", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var APPagreement = function (_React$Component) {
	    _inherits(APPagreement, _React$Component);

	    function APPagreement() {
	        _classCallCheck(this, APPagreement);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(APPagreement).apply(this, arguments));
	    }

	    _createClass(APPagreement, [{
	        key: "render",
	        value: function render() {
	            return React.createElement(
	                "div",
	                ...
	                React.createElement(
	                    ...
	                    "要求的APP应用提供公开平台，需要满足以下要求，通过审核，方能公布到网站，供广大市民下载使用："
	                ),
	                React.createElement(
	                    "p",
	                    null,
	                    "1、所申请APP应用版权需为个人/贵公司所以，不得申请他人版权的APP；"
	                ),
	                React.createElement(
	                    "p",
	                    null,
	                    "2、APP不存在恶意收费、盗取用户账号信息等违规行为；"
	                ),
	                React.createElement(
	                    "p",
	                    null,
	                ...
	                React.createElement(
	                    "p",
	                    null,
	                    "4、现阶段，用户有权免费获取本网站所提供的所有政务数据资源，享有数据资源的非排他使用权。用户不得有偿或无偿转让在本网站中获取的各种数据资源。"
	                ),
	                React.createElement(
	                    "p",
	                    null,
	                    "5、用户应在应用本网站政务数据资源所产生的成果中注明政务数据资源来源为\"北京市政务数据资源网\"，及时将应用情况通过网站进行备案，并应积极配合有关的用户需求调查和数据资源调查。"
	                ),
	                React.createElement(
	                    "p",
	                    null,
	                    "6、用户在发布基于本网站获取的政务数据资源开发的APP应用时，应确保其发布内容不会侵犯任何第三方的合法权益（包括但不限于著作权、商标权、专利权等），不会违反任何法律、法规、条例或规章，如造成法律纠纷及事故，由用户承担相应法律责任。"
	                ),
	                React.createElement(
	                    "p",
	                    null,
	                    "7、本网站包含的所有内容（包括但不限于：文本、图形、图片、视像及声音内容、LOGO标识，版面设计，专栏目录与名称、内容分类）的所有权归北京市人民政府所有。"
	                ),
	                React.createElement(
	                    "p",
	                    null,
	                    "8、在任何情况下，本网站合理地认为用户的行为可能违反法律、法规，本网站可以在任何时候，终止向该用户提供服务，并通知用户。"
	                )
	            );
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var APPform = function (_React$Component) {
		...
		function APPform(props) {
			...
			var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(APPform).call(this, props));
		...
		_createClass(APPform, [{
			key: 'onValidate',
			value: function onValidate(bool) {
				console.log(bool);
			}
		}, {
			key: 'handleSubmit',
			...
			value: function render() {
				return React.createElement(
					...
					React.createElement(
						...
						React.createElement(
							'div',
							{ className: 'section_tr clear' },
							React.createElement(
								'span',
								{ className: 'section_th' },
								React.createElement(
									'strong',
									{ className: 'red' },
									'*'
						...
						React.createElement(
							...
							React.createElement(
								'span',
								{ className: 'section_th' },
								React.createElement('strong', { className: 'red' }),
								'邮箱地址：'
							),
							React.createElement(
								'div',
								{ className: 'section_td' },
								React.createElement(Input, { className: 'input', type: 'text', placeholder: '邮箱',
									onValidate: this.onValidate.bind(this),
									email: { tip: '邮箱格式不合法' }
								})
							)
						...
						React.createElement(
							...
							React.createElement(
								'div',
								{ className: 'section_td' },
								React.createElement(Input, { className: 'input', type: 'text', placeholder: '手机号',
									onValidate: this.onValidate.bind(this),
									required: true
									//max={11}
									, phone: true
						...
						React.createElement(
							...
							React.createElement(
								'div',
								{ className: 'section_td' },
								React.createElement(Input, { className: 'input', type: 'text', placeholder: 'QQ号',
									onValidate: this.onValidate.bind(this),
									required: { tip: '请输入qq号' },
						...
						React.createElement(
							...
							React.createElement(
								'div',
								{ className: 'section_td' },
								React.createElement(Input, { className: 'input', type: 'password', placeholder: '密码',
									required: { tip: '请输入密码' }
								})
							)
						),
						React.createElement(
							...
							React.createElement(
								'div',
								{ className: 'section_td' },
								React.createElement(Input, { className: 'input', type: 'password', placeholder: '重复密码',
						...
						React.createElement(
							...
							React.createElement(
								'div',
								{ className: 'section_td' },
								React.createElement('input', { className: 'input', type: 'text', placeholder: '' })
							)
						),
						React.createElement(
							'div',
							...
							React.createElement(
								...
								React.createElement(
									...
									React.createElement(
										'p',
										null,
										'（应用图标支持JPG、PNG格式，图片不超过3M，大小为120*120px）'
									)
								)
							)
						),
						React.createElement(
							...
							React.createElement(
								'div',
								{ className: 'section_td' },
								React.createElement('textarea', { className: 'textarea', placeholder: '请为您的APP编写完整的描述（描述不少于50个字，不超过300字）' })
							)
						),
						React.createElement(
							'div',
							...
							React.createElement(
								...
								React.createElement(
									'li',
									null,
									React.createElement('input', { className: 'input', type: 'text', placeholder: '请填写APP应用的官方下载地址' }),
									React.createElement(
										'span',
										null,
										'Android 版'
					...
					React.createElement(
						...
						React.createElement(
							...
							React.createElement(
								'a',
								{ className: 'btn02', href: 'javascript:;', onClick: this.handleSubmit.bind(this) },
								'提交'
							),
							React.createElement(
								'a',
								{ className: 'btn03', href: '#' },
								'取消'
							)
						)
					)
	    ...
	    _createClass(Input, [{
	        ...
	        value: function render() {
	            ...
	            return React.createElement(
	                ...
	                React.createElement(
	                    'span',
	                    { style: { width: '200px', position: 'absolute', lineHeight: '42px', marginLeft: '10px', fontSize: '14px', color: 'red' } },
	                    this.state.tip
	                )
	            );
	        }
